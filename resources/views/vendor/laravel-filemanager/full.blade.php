...
@section('content')
  ...
  <div class="d-flex flex-row" style="min-height: 70vh;">
	<div id="tree" style="min-height: 70%;"></div>
	...
	<div id="fab" style="z-index: 1050;"></div>
  </div>
...
<script src="{{ asset('vendor/laravel-filemanager/js/cropper.min.js') }}" defer></script>
<script src="{{ asset('vendor/laravel-filemanager/js/dropzone.min.js') }}" defer></script>
@endsection
